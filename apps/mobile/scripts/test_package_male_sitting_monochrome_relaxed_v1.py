#!/usr/bin/env python3
"""TDD gate for Monochrome Street-Tailoring seated candidate."""
...
SCRIPT = Path(__file__).with_name("package_male_sitting_monochrome_relaxed_v1.py")
SPEC = importlib.util.spec_from_file_location("package_monochrome_relaxed", SCRIPT)
assert SPEC and SPEC.loader
MODULE = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(MODULE)


class PackageMonochromeRelaxedSittingTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_relaxed_volume_and_opaque_tailored_crotch_are_preserved(self) -> None:
