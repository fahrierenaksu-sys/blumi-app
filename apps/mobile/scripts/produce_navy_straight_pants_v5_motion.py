#!/usr/bin/env python3
"""Produce pose-native Navy Straight trousers 4W+1S candidates."""
...
ROOT = (
    REDESIGN
    / "candidates/bottom/navy_straight_pants_v5"
)
GENERATED_ROOT = ROOT / "generated"
OUTPUT_ROOT = ROOT / "motion-v5"
BOARD = ROOT / "navy-straight-pants-v5-4w1s-board.png"
MANIFEST = ROOT / "navy-straight-pants-v5-motion-manifest.json"
REVIEW = ROOT / "navy-straight-pants-v5-independent-review.json"
STATIC_CANDIDATE = (
    REDESIGN
...
def produce() -> dict:
    ...
    manifest = {
        ...
        "method": (
            ...
            "navy-straight-canonical-contact-registration"
        ),
        "staticCandidate": {
