#!/usr/bin/env python3
"""Produce pose-native Mid Blue Straight Jeans trousers 4W+1S candidates."""
...
ROOT = (
    REDESIGN
    / "candidates/bottom/mid_blue_straight_jeans_v4"
)
GENERATED_ROOT = ROOT / "generated"
OUTPUT_ROOT = ROOT / "motion-v4"
BOARD = ROOT / "mid-blue-straight-jeans-v4-4w1s-board.png"
MANIFEST = ROOT / "mid-blue-straight-jeans-v4-motion-manifest.json"
REVIEW = ROOT / "mid-blue-straight-jeans-v4-independent-review.json"
STATIC_CANDIDATE = (
    REDESIGN
    / "candidates/bottom/mid_blue_straight_jeans/rig/"
...
def produce() -> dict:
    ...
    manifest = {
        ...
        "method": (
            ...
            "mid-blue-denim-straight-canonical-contact-registration"
        ),
        "staticCandidate": {
