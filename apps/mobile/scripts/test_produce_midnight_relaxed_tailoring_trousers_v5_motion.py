...
from produce_midnight_relaxed_tailoring_trousers_v5_motion import (  # noqa: E402
    GENERATED_ROOT,
    MOTION,
    OUTPUT_ROOT,
    STATES,
...
class MidnightRelaxedTailoringTrousersV5MotionTests(unittest.TestCase):
    ...
    def test_independent_review_is_bound_to_exact_frame_hashes(self) -> None:
        files = {
            state: {
                "sha256": _sha256(OUTPUT_ROOT / f"{state}-v5.png"),
            }
            for state in STATES
        }
