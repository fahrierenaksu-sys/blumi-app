#!/usr/bin/env python3
"""Produce pose-native Charcoal Tapered Chinos trousers 4W+1S candidates."""
...
ROOT = (
    REDESIGN
    / "candidates/bottom/charcoal_tapered_chinos_v4"
)
GENERATED_ROOT = ROOT / "generated"
OUTPUT_ROOT = ROOT / "motion-v4"
BOARD = ROOT / "charcoal-tapered-chinos-v4-4w1s-board.png"
MANIFEST = ROOT / "charcoal-tapered-chinos-v4-motion-manifest.json"
REVIEW = ROOT / "charcoal-tapered-chinos-v4-independent-review.json"
STATIC_CANDIDATE = (
    REDESIGN
    / "candidates/bottom/charcoal_tapered_chinos/rig/"
...
def produce() -> dict:
    ...
    manifest = {
        ...
        "method": (
            ...
            "charcoal-tapered-chino-canonical-contact-registration"
        ),
        "staticCandidate": {
